...
\section{Skills}
  \resumeSubHeadingListStart 
    \item{
      \textbf{Programming}{: \directlua{printList("_data/personal.json", "programming", "programming")}}
      }
    \vspace{-5pt}
    \item{
      \textbf{Software}{: \directlua{printList("_data/personal.json", "software", "software")}}
      }
    \vspace{-5pt}
    \item{
      \textbf{Courses}{: \directlua{printList("_data/personal.json", "course", "course")}}
      }
  \resumeSubHeadingListEnd
